    ...
    <div class="main-container">
        ...
        <main>
            <div class="container">
                ...
                <div class="content">
                    <form action="actions/registerstudent_process.php" method="POST" id="applicationForm" class="d-flex flex-column">
                        <p class="text-color-3 m-b">Welcome to Khalifah Garden! We're excited you're interested in enrolling your child in our kindergarten program.</p>
                        ...
                        <section class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="parentNationality" id="parentNationality">
                            </div>
                            <div class="form-group-multiple">
                                <div class="form-group">
                        ...
                        <button type="submit" name="submit" class="btn-submit">Register Now</button>
                    </form>
                </div>
            </div>
        </main>
